...
export const navItems = [
  ...
  { label: "Programación", path: "/programacion", icon: CalendarDays, tourId: "nav-programacion", roles: ["admin", "editor", "viewer"], viewerTypes: ["corista"] },
  { label: "Músicos", path: "/musicos", icon: Music2, tourId: "nav-musicos", roles: ["admin", "editor", "viewer"], viewerTypes: ["corista"] },
  { label: "Servicios", path: "/servicios", icon: PanelsTopLeft, tourId: "nav-servicios", roles: ["viewer"], viewerTypes: ["medios"] },
